    ...
    <>
      <div className="p-1 flex flex-col items-center">
        ...
        <h2 className="text-lg font-thin mb-12">
          Chats | People nearby (maps) | Matching | Favourites (bookmarked
          people)
        </h2>
      </div>
      ...
      <div className="flex flex-wrap gap-y-4 gap-x-4 justify-center">
        <div>
          <button
            ...
            className="w-64 flex items-center justify-center  h-32 bg-zinc-500 text-white text-4xl rounded-lg shadow-lg"
          >
            <HiChatAlt2 />
          </button>
        </div>
